...
suite already round-trips its own mapping through finlink_core's reference
parser (catches "is this valid JSON finlink_core can parse"), but nothing
...
of "slot_unavailable" would pass its own tests (finlink_core's parser
...
only cross-repo check, hence living here in finlink -- the coordinating
...
HOSTS = [
    ("Cemu", "https://github.com/alwe2710/cemu-screen-stream.git", "transcoding",
     "src/Cemu/finlinkStream/FinlinkMessages.cpp"),
    ...
    ("melonDS", "https://github.com/alwe2710/melonds-screen-stream.git", "master",
     "src/streaming/FinlinkMessages.cpp"),
