...
// unison_3ds_remix_to_stereo() (audio_remix.hpp/.cpp) -- the
...
static void TestMonoDuplicatesToBothChannels() {
    ...
    unison_3ds_remix_to_stereo(mono.data(), mono.size(), 1, out.data());
...
static void TestStereoPassesThroughVerbatim() {
    ...
    unison_3ds_remix_to_stereo(stereo.data(), 2, 2, out.data());
...
static void TestExtraChannelsBeyondStereoAreIgnored() {
    ...
    unison_3ds_remix_to_stereo(quad.data(), 2, 4, out.data());
