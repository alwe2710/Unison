/* UDP discovery beacon listener for the Unison lobby (unison/discovery.h,
...
typedef struct {
    ...
    bool compatible; /* beacon.protocol_version == UNISON_PROTOCOL_VERSION */
...
/* Opens and binds the UDP socket (UNISON_BEACON_PORT), resets scan for a
 ...
 * entries not refreshed within UNISON_BEACON_STALE_MS. Never "finishes"
