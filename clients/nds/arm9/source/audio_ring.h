#ifndef FINLINK_NDS_AUDIO_RING_H
#define FINLINK_NDS_AUDIO_RING_H

#include <stddef.h>
#include <stdint.h>

/* Jitter-buffer ring for GC_GBA_LINK's FINLINK_MSG_AUDIO frames -- pulled
 ...
 * wrapper around finlink_nds_audio_ring_pull() below) so the actual FIFO
 ...
 * see finlink_read_s16le) into the ring. On overflow (not enough room for
...
#endif /* FINLINK_NDS_AUDIO_RING_H */
